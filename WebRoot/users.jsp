...
<div class="zhong">  
  ...
  <div class="main">
    ...
    <div class="right">
      ...
      <div class="news">
        <div class="news_title" style="font-size: 18px; font-weight:bold; text-align: center;height: 40px;">${requestScope.users.company }<br />
</div>
       <p>${requestScope.users.introduce} </p>
      </div>
    </div>
    <div class="clear"></div>    
  </div> 
