...
<div class="zhong">  
  ...
  <div class="main">
    ...
    <div class="right">
      ...
      <div class="news">
        <div class="news_title" style="font-size: 18px; font-weight:bold; text-align: center;height: 60px;">${requestScope.law.title }<br />
<p style="font-size: 12px;font-weight: normal;" >发布机构：${requestScope.law.organ } &nbsp;  发布时间：${requestScope.law.ldate }</p>
</div>
       <p>${requestScope.law.content} </p>
      </div>
    </div>
    <div class="clear"></div>    
  </div> 
